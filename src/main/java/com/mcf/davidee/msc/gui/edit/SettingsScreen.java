...
public class SettingsScreen extends MSCScreen {
    ...
    protected void createGui() {
        ...
        container
            .addWidgets(close, save, mon, cre, amb, wat, readOnly, masterEnabled, creatureFreq, freqLabel, title, cap);
    ...
    private void save() {
        ...
        MobSpawnControls.DISPATCHER.sendToServer(
            MSCPacket.getPacket(PacketType.SETTINGS, readOnly.isChecked(), masterEnabled.isChecked(), caps, cFreq));
    }
}
